							...
							<td width="709" align="center" valign="top" bgcolor="#F6F9FE"><table
									...
									<tr>
										<td height="470" align="center" valign="top" bgcolor="#F6F9FE"><form
												...
												action="/dorm/domitory/updatesave_domitoryManager.action"
												onSubmit="return mycheck()">
												<table width="100%" border="0" cellspacing="0"
													cellpadding="0">
													<tr>
														<td width="33%" height="30" align="right">&nbsp;</td>
														<td width="67%"><input name="domitory.domitory_ID" type="text"
															class="noshow" id="Domitory_ID"
															value="<s:property value='domitory.domitory_ID'/>">
														</td>
													</tr>
													<tr>
															...
															id="Domitory_BuildingID">
																...
																<s:iterator id="aa" value="buildingList">
																	<option value="${Building_ID}"
																		<s:if test="domitory.domitory_BuildingID==building_ID">selected</s:if>>${building_Name}</option>
																</s:iterator>
														</select>
														</td>
													</tr>
													<tr>
														...
														<td><input name="domitory.domitory_Name" type="text"
															...
															value="<s:property value='domitory.domitory_Name'/>">
														</td>
													</tr>
													<tr>
														<td height="30" align="right"><span
															style="color:red;">*</span>寝室人数：</td>
														<td><input name="domitory.domitory_totalNumber" type="text"
															class="text2" id="Domitory_Type"
															value="<s:property value='domitory.domitory_totalNumber'/>">
														</td>
													</tr>
													<tr>
														<td height="30" align="right"><span
														...
														<td><input name="domitory.domitory_Tel" type="text"
															...
															value="<s:property value='domitory.Domitory_Tel'/>">
														</td>
													</tr>
													<tr>
														<td height="30">&nbsp;</td>
