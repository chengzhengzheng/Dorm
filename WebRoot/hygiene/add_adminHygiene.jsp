									...
									<tr>
										<td height="470" align="center" valign="top" bgcolor="#F6F9FE">
											<form name="form1" method="post"
												action="/dorm/hygiene/addsave_hygieneManager.action"
											 ...
											 -->
												<table width="100%" border="0" cellspacing="0"
													...
													<tr>
														...
														<td><select name="hygiene.building_ID"
															id="Building_ID">
																<option value="">请选择</option>
																<s:iterator value="all_Buildings">
													...
													<tr>
														...
														<td><select name="hygiene.domitory_ID"
															id="Domitory_ID">
																<option value="">请选择</option>
														</select></td>
													</tr>
													<tr>
														...
														<td><select name="hygiene.teacher_ID" id="Teacher_ID">
																<option value="">请选择</option>
														</select></td>
													</tr>
													<tr>
														...
														<td><label for="Student_ID"></label> <input
															type="text" name="hygiene.score" id="score"></td>
													</tr>
													<tr>
														<td height="30">&nbsp;</td>
