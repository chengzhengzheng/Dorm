							...
							<td width="709" align="center" valign="top" bgcolor="#F6F9FE"><table
									...
									<tr>
										<td height="470" align="center" valign="top" bgcolor="#F6F9FE"><form
												...
												action="updatesave_buildingManager.action"
												onSubmit="return mycheck()">
												<table width="100%" border="0" cellspacing="0"
													cellpadding="0">
													<tr>
														<td width="33%" height="30" align="right">&nbsp;</td>
														<td width="67%"><input name="building.building_ID" type="text"
															class="noshow" id="building_ID"
															value="<s:property value='building.building_ID'/>">
														</td>
													</tr>
													<tr>
														<td height="30" align="right"><span
															style="color:red;">*</span>用户名：</td>
														<td><input name="building.building_Name" type="text"
															class="text2" id="Building_Name"
															value="<s:property value='building.building_Name'/>">
														</td>
													</tr>
													<tr>
														<td height="30" align="right"><span
															style="color:red;">*</span>联系电话：</td>
														<td><textarea name="building.building_Introduction"
																id="Building_Introduction" cols="45" rows="5">
																<s:property value='building.building_Introduction' />
															</textarea>
														</td>
													</tr>
													<tr>
