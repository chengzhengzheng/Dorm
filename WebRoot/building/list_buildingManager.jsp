							...
							<td width="709" align="center" valign="top" bgcolor="#F6F9FE"><table
									...
									<tr>
										<td height="470" align="center" valign="top" bgcolor="#F6F9FE"><form
												...
												action="/dorm/building/queryBuilding.action">
												<table width="100%%" border="0" cellspacing="0"
													cellpadding="0">
													<tr>
														<td width="28%" height="30" style="padding-left:20px;">
															功能导航： <a href="add_buildingManager.jsp">添加楼宇</a>
														</td>
														<td width="72%">名称： <input name="searchKey"
															type="text" class="text1" id="SearchKey"> <input
															type="submit" name="button" id="button" value="点击查询">
														</td>
													</tr>
												</table>
											</form>
											<table width="100%" border="0" cellspacing="0"
												...
												<tr align="center" class="t1">
													<td height="25" bgcolor="#D5E4F4"><strong>名称</strong>
													</td>
													<td bgcolor="#D5E4F4"><strong>简介</strong>
													</td>
													<td bgcolor="#D5E4F4"><strong>操作</strong>
													</td>
												</tr>
												<s:iterator id="aa" value="builds">
													<tr align="center">
														<td height="25" align="center">${Building_Name}</td>
														<td>${Building_Introduction}</td>
														<td align="center"><a
															href="/dorm/building/list_TBManager.action?building_ID=${Building_ID}">管理员</a>
															<a
															href="update_buildingManager.action?building_ID=${Building_ID}">修改</a>
															<a href="del_buildingManager.action?building_ID=${Building_ID}"
