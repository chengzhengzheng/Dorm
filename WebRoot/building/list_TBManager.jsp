									...
									<tr>
										<td height="470" align="center" valign="top" bgcolor="#F6F9FE">
											<form name="form1" method="post"
												action="/dorm/building/addsave_TBManager" onsubmit=" return mycheck()">
												<table width="100%%" border="0" cellspacing="0"
													cellpadding="0">
													<tr>
														<td width="42%" height="30" style="padding-left:20px;">
															功能导航： <a href="/dorm/building/list_buildingManager.action">返回上层</a>
														</td>
														<td width="58%">添加管理员： <select name="tB_TeacherID"
															...
															<input name="building_ID" type="text" class="noshow"
															id="TB_BuildingID" value="${building_ID}">
														</td>
													</tr>
												</table>
											</form>
											<table width="100%" border="0" cellspacing="0"
												...
												<tr align="center" class="t1">
													...
													<td bgcolor="#D5E4F4"><strong>用户名</strong>
													</td>
												...
												<s:iterator id="aa" value="teachers">
													<tr align="center">
														...
														<td align="center"><a
															href="del_TBManager.action?tB_TeacherID=${teacher_ID}&building_ID=${building_ID}"
															onClick="return confirm('确定要将该管理员从该楼宇移除吗？')">移除</a>
														</td>
													</tr>
												</s:iterator>
											</table>
