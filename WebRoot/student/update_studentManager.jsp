							...
							<td width="709" align="center" valign="top" bgcolor="#F6F9FE"><table
									...
									<tr>
										<td height="470" align="center" valign="top" bgcolor="#F6F9FE"><form
												name="form1" method="post" action="updatesave_studentManager.action"
												onSubmit="return mycheck()">
												<input type="hidden" name="student.student_State" value='<s:property value='student.student_State'/>'>
												<table width="100%" border="0" cellspacing="0"
													cellpadding="0">
													<tr>
														<td width="33%" height="30" align="right">&nbsp;</td>
														<td width="67%"><input name="student.Student_ID" type="text"
													...
													<tr>
														...
														<td><input name="student.Student_Username" type="text"
															class="text2" id="Student_Username"
															value="<s:property value='student.Student_Username'/>">
														</td>
													</tr>
													<tr>
														<td height="30" align="right">密码：</td>
														<td><input name="student.Student_Password" type="password"
													...
													<tr>
														...
														<td><input name="student.Student_Name" type="text"
															class="text2" id="Student_Name"
															value="<s:property value='student.Student_Name'/>">
														</td>
													</tr>
													<tr>
														<td height="30" align="right"><span
															style="color:red;">*</span>性别：</td>
														<td><select name="student.Student_Sex" id="Student_Sex">
																<option value="">请选择</option>
																<option value="男"
																	<s:if test='student.Student_Sex=="男"'>selected</s:if>>男
																</option>
																<option value="女"
																	<s:if test='student.Student_Sex=="女"'>selected</s:if>>女
																</option>
														</select>
														</td>
													</tr>
													<tr>
														...
														<td><input name="student.Student_Class" type="text"
															class="text2" id="Student_Class"
															value="<s:property value='student.Student_Class'/>">
														</td>
													</tr>
													<tr>
														<td height="30">&nbsp;</td>
