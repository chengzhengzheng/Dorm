							...
							<td width="709" align="center" valign="top" bgcolor="#F6F9FE"><table
									...
									<tr>
										<td height="470" align="center" valign="top" bgcolor="#F6F9FE"><form
												name="form1" method="post" action="addsave_teacherManager.action"
												...
												<table width="100%" border="0" cellspacing="0"
													...
													<tr>
														...
														<td><input name="teacher.Teacher_Username" type="text"
													...
													<tr>
														...
														<td><input name="teacher.Teacher_Password" type="password"
													...
													<tr>
														...
														<td><input name="teacher.Teacher_Password2" type="password"
															class="text2" id="Teacher_Password2">
														</td>
													</tr>
													<tr>
														<td height="30" align="right"><span
															style="color:red;">*</span>姓名：</td>
														<td><input name="teacher.Teacher_Name" type="text"
													...
													<tr>
														...
														<td><select name="teacher.Teacher_Sex" id="Teacher_Sex">
													...
													<tr>
														...
														<td><input name="teacher.Teacher_Tel" type="text"
