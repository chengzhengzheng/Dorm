							...
							<td width="709" align="center" valign="top" bgcolor="#F6F9FE"><table
									...
									<tr>
										<td height="470" align="center" valign="top" bgcolor="#F6F9FE"><form
												name="form1" method="post" action="updatesave_teacherManager.action"
												onSubmit="return mycheck()">
												<table width="100%" border="0" cellspacing="0"
													cellpadding="0">
													<tr>
														<td width="33%" height="30" align="right">&nbsp;</td>
														<td width="67%"><input name="current_Teacher.teacher_ID" type="text"
															class="noshow" id="Teacher_ID"
															value="<s:property value='current_Teacher.Teacher_ID'/>">
														</td>
													</tr>
													<tr>
														<td height="30" align="right"><span
															style="color:red;">*</span>用户名：</td>
														<td><input name="current_Teacher.teacher_Username" type="text"
															class="text2" id="Teacher_Username"
															value="<s:property value='current_Teacher.Teacher_Username'/>">
														</td>
													</tr>
													<tr>
														<td height="30" align="right">密码：</td>
														<td><input name="current_Teacher.teacher_Password" type="password"
															class="text2" id="Teacher_Password"> <span
															style="color:#F60">不修改则不填写</span>
														</td>
													</tr>
													<tr>
													...
													<tr>
														...
														<td><input name="current_Teacher.teacher_Name" type="text"
															class="text2" id="Teacher_Name"
															value="<s:property value='current_Teacher.Teacher_Name'/>">
														</td>
													</tr>
													<tr>
														<td height="30" align="right"><span
															style="color:red;">*</span>性别：</td>
														<td><select name="current_Teacher.teacher_Sex" id="Teacher_Sex">
																<option value="">请选择</option>
																<option value="男"
																	<s:if test='current_Teacher.Teacher_Sex=="男"'>selected</s:if>>男
																</option>
																<option value="女"
																	<s:if test='current_Teacher.Teacher_Sex=="女"'>selected</s:if>>女
																</option>
														</select>
														</td>
													</tr>
													<tr>
														...
														<td><input name="current_Teacher.teacher_Tel" type="text"
															class="text2" id="Teacher_Tel"
															value="<s:property value='current_Teacher.Teacher_Tel'/>">
														</td>
													</tr>
													<tr>
														<td height="30">&nbsp;</td>
