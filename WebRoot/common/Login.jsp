					...
					<table width="350" height="201" border="0" cellpadding="0"
						...
						<tr>
							<td align="center" valign="top">
								<form name="form1" action="/dorm/student/GoLogin.action"
									method="post" onSubmit="return mycheck()">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td height="30" colspan="2" align="center" class="STYLE2"><span
												style="color:red;"> <s:property value="message" /> </span></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td width="300" align="left"><input type="text"
												name="Username" id="Username" class="text1"  value="${Username}"/></td>
										</tr>
										<tr>
											<td height="30" align="right" class="STYLE2">密码：</td>
											<td align="left"><input type="password" name="Password"
												id="Password" class="text1"  value="${Password}"/>
										</tr>
										<tr>
